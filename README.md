...
порядок 10 а оператор остаток от деления 14. Поэтому сначало обработается оператор  строго сравнения `===` видим у него есть
два операнда это выражения слева и справа от него. Выражение левой части возвращает число 1 это остаток от деления 3 на 2.
Получим более простой вид преведя выражение слева к числу
...
```
Как я уже сказал ранее это нормально 
